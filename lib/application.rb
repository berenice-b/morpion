...
class Router
    ...
    def perform #rappelle-toi que l'on fait "Router.new.perform" dans app.rb => après initialize, on définit perform.
        ...
        while true
            ...
            puts "2. Je veux afficher la liste des rumeurs"
            puts "3. Je veux supprimer une rumeur de la liste"
            ...
            when 2
                puts "Tu as choisi d'afficher la liste des rumeurs" 
                @controller.index_gossip
            when 3
                puts "Tu as choisi de supprimer une rumeur" 
